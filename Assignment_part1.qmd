...
# Excluding second and fourth lag
...
kable(forecast_10db[,1:2], caption="The predicted quarterly GDP growth rates using ARIMA(4,0,0) with second and fourth lags removed and 90% CI", col.names = c("Quarter", "Predicted growth %"), digits = 3, row.names = F)
```
