...
p_load(devtools,tidyverse,dplyr,ggplot2,latex2exp,stargazer, fixest, modelsummary, knitr, readr, tseries, lmtest, forecast, dynlm, vars)
...
```
The obtained estimates indicates that the GDP growth rates increases steadily and quickly. On the other hand, the unemployment rates experiences fluctuations and there is no clear increasing trend.
