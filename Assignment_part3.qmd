...
```{r q3}
ADF_Apple = ur.df(dfAssign_p3$APPLE, type =  "none", lags = 1,
      selectlags = "BIC")
ADF_Exxon = ur.df(dfAssign_p3$EXXON_MOBIL, type =  "none", lags = 1,
      selectlags = "BIC")
ADF_Ford = ur.df(dfAssign_p3$FORD, type =  "none", lags = 1,
      selectlags = "BIC")
ADF_GenElectric = ur.df(dfAssign_p3$GEN_ELECTRIC, type =  "none", lags = 1,
      selectlags = "BIC")
ADF_Intel = ur.df(dfAssign_p3$INTEL, type =  "none", lags = 1,
      selectlags = "BIC")
ADF_Micro = ur.df(dfAssign_p3$MICROSOFT, type =  "none", lags = 1,
      selectlags = "BIC")
ADF_Netflix = ur.df(dfAssign_p3$NETFLIX, type =  "none", lags = 1,
      selectlags = "BIC")
ADF_Nokia = ur.df(dfAssign_p3$NOKIA, type =  "none", lags = 1,
      selectlags = "BIC")
ADF_SP500 = ur.df(dfAssign_p3$SP500, type =  "none", lags = 1,
      selectlags = "BIC")
ADF_Yahoo = ur.df(dfAssign_p3$YAHOO, type =  "none", lags = 1,
      selectlags = "BIC")
```
\begin{table}[H]
\centering
...
Exxon Mobil  & 0.091              & 1         & 0.928   & -1.62                  \\
Ford         & 0.067              & 1         & 0.946   & -1.62                  \\
Gen Electric & -1.361             & 1         & 0.174   & -1.62                  \\
Intel        & -0.358             & 1         & 0.721   & -1.62                  \\
Microsoft    & -0.418             & 1         & 0.676   & -1.62                  \\
Netflix      & 0.136              & 1         & 0.892   & -1.62                  \\
Nokia        & -1.255             & 1         & 0.210   & -1.62                  \\
SP500        & -0.139             & 1         & 0.889   & -1.62                  \\
Yahoo        & -1.215             & 1         & 0.224   & -1.62                 
\end{tabular}
