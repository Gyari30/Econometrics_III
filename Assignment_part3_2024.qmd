...
abstract: |
  | Disclaimer: This assignment was originally prepared for the 2022/23 version of the course in teams of two, but Thao Le (523716) has already passed this course and hence the assignment is resubmitted by David Gyaraki (582340). The code has been slightly changed to align with the 2023/24 version.
format: pdf
pdf:
